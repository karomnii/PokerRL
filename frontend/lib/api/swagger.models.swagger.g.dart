...
CommunityCard _$CommunityCardFromJson(Map<String, dynamic> json) =>
    CommunityCard(
      communityCardId: (json['communityCardId'] as num?)?.toInt() ?? 0,
      gameRoundId: (json['gameRoundId'] as num?)?.toInt() ?? 0,
      cardId: (json['cardId'] as num?)?.toInt() ?? 0,
...
Game _$GameFromJson(Map<String, dynamic> json) => Game(
      ...
      currentTurnPlayerId: (json['currentTurnPlayerId'] as num?)?.toInt() ?? 0,
...
GamePlayer _$GamePlayerFromJson(Map<String, dynamic> json) => GamePlayer(
      gamePlayerId: (json['gamePlayerId'] as num?)?.toInt() ?? 0,
      gameId: (json['gameId'] as num?)?.toInt() ?? 0,
      userId: (json['userId'] as num?)?.toInt() ?? 0,
      seatPosition: (json['seatPosition'] as num?)?.toInt() ?? 0,
      initialChips: (json['initialChips'] as num?)?.toInt() ?? 0,
...
GameRoundWinner _$GameRoundWinnerFromJson(Map<String, dynamic> json) =>
    GameRoundWinner(
      gameRoundWinnerId: (json['gameRoundWinnerId'] as num?)?.toInt() ?? 0,
      gameRoundId: (json['gameRoundId'] as num?)?.toInt() ?? 0,
      userId: (json['userId'] as num?)?.toInt() ?? 0,
...
PlayerCard _$PlayerCardFromJson(Map<String, dynamic> json) => PlayerCard(
      playerCardId: (json['playerCardId'] as num?)?.toInt() ?? 0,
      gamePlayerId: (json['gamePlayerId'] as num?)?.toInt() ?? 0,
      userId: (json['userId'] as num?)?.toInt() ?? 0,
      gameRoundId: (json['gameRoundId'] as num?)?.toInt() ?? 0,
      cardId: (json['cardId'] as num?)?.toInt() ?? 0,
...
UserModel _$UserModelFromJson(Map<String, dynamic> json) => UserModel(
      userModelId: (json['userModelId'] as num?)?.toInt() ?? 0,
      userId: (json['userId'] as num?)?.toInt() ?? 0,
      modelId: (json['modelId'] as num?)?.toInt() ?? 0,
